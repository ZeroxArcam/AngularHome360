...
// import { ControlValueAccessor, NG_VALUE_ACCESSOR, FormControl } from '@angular/forms'; // Import FormControl
...
//   @Input() inputValue: string = ''; // Mantenemos inputValue
...
//   @Input() formControl?: FormControl; // Recibimos el FormControl del padre
...
//       this.value = value;
//       this.currentValueLength = this.value.length;
//       this.onChange(this.value); // Notificamos el cambio al FormControl padre
//       this.onTouched();
//       this.inputValueChange.emit(this.value); // Emitimos el valor si el padre lo necesita
//       if (this.formControl) {
//         this.formControl.setValue(this.value); // Actualizamos el FormControl directamente
//       }
//     }
//   }
// }
